/*
 * srec2vram.c
 *   from https://raw.githubusercontent.com/das-labor/legacy/master/fpga/farbborg/tools/srec2vram/srec2vram.c
 */
#define _GNU_SOURCE
...
int main(int argc, char **argv)
{
	...
	while( !feof(infile) ) {
		...
		char * rcptr = fgets(line, LINESIZE, infile);
		if ( rcptr == NULL ) {
			fprintf( stderr, "Failed fgets()\n");
			continue;
		}
