...
def test21_post(endpoint=None):
    ...
    access_key = 'AKIAXGPHY5OX'
    secret_key = 'ct6rboFA5AB2+uG6k3ekm'
    ...
    canonical_headers = 'host:' + host + '\n' + 'x-amz-date:' + amz_date + '\n' + 'x-amzn-stream-name:' + 'my-video-stream-test3' + '\n'
    ...
    signed_headers = 'host;x-amz-date;x-amzn-fragment-timecode-type;x-amzn-producer-start-timestamp;x-amzn-stream-name;'

    # Step 6: Create payload hash. In this example, the payload (body of
    # the request) contains the request parameters.
    ###payload_hash = hashlib.sha256(request_parameters.encode('utf-8')).hexdigest()
    request_parameters = 'abcd' ###
    payload_hash = hashlib.sha256(request_parameters.encode('utf-8')).hexdigest()
    ...
    headers = {###'Content-Type': content_type,
               ...
               'X-Amzn-Producer-Start-Timestamp': '1234',
               'X-Amz-Date': amz_date,
...
def test22():
    ...
    print("endpoint %s" % endpoint) #  https://s-1e415f8b.kinesisvideo.us-east-1.amazonaws.com

    test21_post(endpoint=endpoint)
