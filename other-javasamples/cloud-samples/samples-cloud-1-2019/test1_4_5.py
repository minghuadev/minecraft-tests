...
#    (HEAD at 2.0.2) 116b904 fix bug where producer cannot recover  from STATUS_STORE_OUT_OF_MEMORY after network outage
...
class gen_request_parameters:
    def __init__(self):
        ...
        if True:
            ...
            #localfile = 'test1.mkv' # fragment error timecode lesser than previous
            localfile = 'outs/out28-6782.webm' # upload ok
...
# test1_4_5:
#    Response code: 200
#    {"EventType":"BUFFERING","FragmentTimecode":0,"FragmentNumber":"91343852333181566090206305446534862533338034118"}
#    {"EventType":"RECEIVED","FragmentTimecode":0,"FragmentNumber":"91343852333181566090206305446534862533338034118"}
#    {"EventType":"PERSISTED","FragmentTimecode":0,"FragmentNumber":"91343852333181566090206305446534862533338034118"}
