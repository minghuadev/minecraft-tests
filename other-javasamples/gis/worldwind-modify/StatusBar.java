...
public class StatusBar extends JPanel implements PositionListener, RenderingListener
{
    ...
    protected final JLabel myWindDisplay = new JLabel("");
    protected final JPanel myWindPanel1 = new JPanel();
    protected final JPanel myWindPanel2 = new JPanel();
    ...
    public StatusBar()
    {
        ...
        myWindPanel1.setLayout(new GridLayout(1,0));
        this.add(myWindPanel1);
        this.add(myWindPanel2);
        ...
        myWindDisplay.setHorizontalAlignment(SwingConstants.CENTER);
        ...
        ///this.add(eleDisplay);
        ///this.add(heartBeat);
        myWindPanel1.add(altDisplay);
        myWindPanel1.add(latDisplay);
        myWindPanel1.add(lonDisplay);
        myWindPanel1.add(eleDisplay);
        myWindPanel1.add(heartBeat);
        myWindPanel2.add(myWindDisplay);
    ...
    protected void handleCursorPositionChange(PositionEvent event)
    {
        ...
        myWindDisplay.setText(MyWind.getShowString());
    }
