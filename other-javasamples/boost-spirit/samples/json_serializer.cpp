/*
http://andres.senac.es/2011/04/generic-json-serializer.html

http://coliru.stacked-crooked.com/a/491094b818c57a5b

set -x ; clang++ -std=c++11 -O0 -Wall -pedantic main.cpp && ./a.out

+ clang++ -std=c++11 -O0 -Wall -pedantic main.cpp

+ ./a.out

{"my_integer": 1, "my_array": [42, -42], "my_other_structs": [{"my_other_integer": 11}, {"my_other_integer": 22}, {"my_other_integer": 33}]}
*/
