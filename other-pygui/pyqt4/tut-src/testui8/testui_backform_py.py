...
class Ui_TestBackform(QtGui.QWidget):
    def __init__(self, backform_name, top_tmr_arg, tmr_intvl, model=None):
        ...
        self.ui_node.refInnerVbox.setContentsMargins(-1, 1, -1, 1)
        self.ui_node.refInnerVbox.setSpacing(1)
        ...
        for n in range(0, self._nSlots):
            ...
            sect.refInnerVbox.setContentsMargins(-1, 1, -1, 1)
            sect.refInnerVbox.setSpacing(1)
            sect.refInnerList = []
