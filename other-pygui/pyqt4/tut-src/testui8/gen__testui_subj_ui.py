...
class Ui_SubjForm(object):
    def setupUi(self, SubjForm):
        ...
        self.subjLabel.setMaximumSize(QtCore.QSize(16777215, 16))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.subjEdit.sizePolicy().hasHeightForWidth())
        self.subjEdit.setSizePolicy(sizePolicy)
        self.subjEdit.setMaximumSize(QtCore.QSize(16777215, 16))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.subjSlider.sizePolicy().hasHeightForWidth())
        self.subjSlider.setSizePolicy(sizePolicy)
        self.subjSlider.setMaximumSize(QtCore.QSize(16777215, 16))
        ...
        self.subjButton.setMaximumSize(QtCore.QSize(16777215, 16))
        font = QtGui.QFont()
        font.setPointSize(6)
        self.subjButton.setFont(font)
        self.subjButton.setIconSize(QtCore.QSize(16, 12))
        ...
        self.subjPerm.setMaximumSize(QtCore.QSize(16777215, 16))
